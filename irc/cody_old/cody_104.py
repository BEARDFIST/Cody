...
helpCommands   	    = [  'problem', 'version', 'uptime', 'feature', 'bug', 'python', 'join', 'part']

codyQuitTriggers    = [  'quit', 'gtfo', 'get out', 'fuck off', 'go away', 'terminate']

approvedHosts 		= [ 'lmn@lmn.user.globalgamers.net', 'inveracity@inveracity.user.globalgamers.net', 'stoy@stoy.user.globalgamers.net', ]

approvedNicks		= [ 'inveracity', 'stoy', 'lmn', 'delrio']

#VALIDATION
def authenticateHost():
	return HOST.lower() in approvedHosts
