...
class Cody():  
	...
	def codyDiag(self, trigger):
		...
		#print "HD:total " +str(diskStats[0])+ "MB, used " +str(diskStats[1])+ "MB, free " +str(diskStats[2])+ "MB | CPU: " +cpuStats+"%"
		...
		if diskStats and cpuStats:
			...
			self.IRC.send("PRIVMSG "+self.MSG_CHANNEL+ " :"+ \
														...
														reset + "| CPU Usage: " 		+ lcyan  +str(cpuStats)    + "% " 	 +\
														reset + "| System uptime: " 	+ dgreen +str(sysUptime[0])+ " days "+ \
														"\r\n")
		else:
