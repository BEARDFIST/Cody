...
class Cody(Daemon):
	...
	def __init__(self, pidfile, stdin='/dev/null', stdout='/dev/null', stderr='/dev/null'):
		...
		self.FILE_NAME 					=   inspect.getfile(inspect.currentframe()) # Dropbox/Cody/cody_dev.py
		self.FILE_PATH 					=  	os.path.abspath(self.FILE_NAME) # /root/Dropbox/Cody/cody_dev.py
		self.FILE_DIR					=   self.FILE_PATH[:self.FILE_PATH.find('cody')] #/root/Dropbox/Cody/
		...
		self.PUBLIC_FUNCTIONS			=	{	 '!cody.python':codyfunctions.public.codyPython,		' cody':codyfunctions.public.hiCody,					'!cody.version':codyfunctions.public.codyVersion, 				 
												 ...
												 '!cody.google':codyfunctions.public.codyGoogle }
