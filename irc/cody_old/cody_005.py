...
#!python.problem
	if data.find ( '!python.problem' ) != -1 or data.find ( '!Python.problem' ) != -1 or data.find ( '!Python.Problem' ) != -1:
...
#lmnPong
	if data.find ( '!lmnPong' ) != -1:
		...
		lmnPong = True		
	if data.find ( '. |' ) != -1 and lmnPong == True:
		irc.send ( 'PRIVMSG #code :|  .\r\n')
	if data.find ( '.  |' ) != -1 and lmnPong == True:
		irc.send ( 'PRIVMSG #code :| .\r\n')
	if data.find ( '.    |' ) != -1 and lmnPong == True:
	...
	if data.find ( '.|' ) != -1 and lmnPong == True:
		...
		lmnPong = False
#hiCody		
	if data.find ( 'hi cody' ) != -1 or data.find ( 'hi, cody' ) != -1 or data.find ( 'Hi cody' ) != -1 or data.find ( 'Hi, cody' ) != -1 or data.find ( 'hi, Cody' ) != -1 or data.find ( 'hi Cody' ) != -1 or data.find ( 'hello cody'  ) != -1 or data.find ( 'hello, cody' ) != -1 or data.find ( 'Hello cody' ) != -1 or data.find ( 'Hello, cody' ) != -1 or data.find ( 'hello Cody' ) != -1 or data.find ( 'Hello, Cody' ) != -1 or data.find ( 'hello, Cody' ) != -1:	
