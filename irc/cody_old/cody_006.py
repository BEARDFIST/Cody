...
#python parser via tumbolia.appspot.com/py/
	if data.find ( '!python.expression') != -1 and connected == True:
		...
		print response
		print pyInput
	elif data.find ( '!python.exPos') != -1 and connected == True:
		irc.send ( 'PRIVMSG #code :' + str(pythonExpressionPos) + ' \r\n')
	elif data.find ( '!python.exInput') != -1 and connected == True:
		irc.send ( 'PRIVMSG #code :' + pyInput + ' \r\n')
	elif data.find ( '!python.exRaw') != -1 and connected == True:
		irc.send ( 'PRIVMSG #code :' + pythonExpression + ' \r\n')
